      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-12 lg:flex-row items-center justify-between px-4">
        <div className="w-full lg:w-6/12 space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="#projects"
              className="inline-flex items-center gap-2 rounded-full border border-cyan-500/40 bg-white/5 px-6 py-3 text-sm font-semibold text-cyan-200 transition hover:bg-cyan-500/10"
            >
              See My Work
            </a>
          </div>
