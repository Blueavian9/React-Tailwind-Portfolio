...
const Blog = () => {
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn how to integrate OpenAI's GPT models with AWS services for production-ready AI applications.",
    ...
    },
    {
      ...
      excerpt: "Explore compound components, render props, and custom hooks for building maintainable React applications.",
      category: "Frontend",
      date: "2024-01-10",
    ...
    },
    {
      ...
      excerpt: "Implement robust CI/CD pipelines using Docker containers and AWS services for reliable deployments.",
      category: "DevOps",
      date: "2024-01-05",
    ...
    },
    {
      ...
      excerpt: "Design principles for building cloud-native applications that can handle millions of users.",
    ...
    },
    {
      ...
      excerpt: "Exploring how AI tools are transforming the software development lifecycle and what it means for developers.",
      category: "AI Integration",
      date: "2023-12-20",
      readTime: "7 min read",
      image: "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800",
    ...
    },
    {
      ...
      excerpt: "Create responsive real-time applications using WebSockets, Socket.io, and modern Node.js patterns.",
      category: "Backend",
      date: "2023-12-15",
  ...
  const categories = ['All', 'AI Integration', 'Frontend', 'DevOps', 'Cloud Architecture', 'Backend'];
  ...
  if (selectedArticle) {
    return (
      <section id="blog" className="py-20 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 min-h-screen">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Insights on AI integration, cloud architecture, and modern software development practices
          </p>
        </div>
